...
app.get('/:info',validateToken(), (req, res) => {
...
// end-point GET by ID
app.get('/:info/:id',validateToken(),(req,res)=>{                      
    var info = req.params.info
    if(info != 'mobil' && info != 'pelanggan' && info != 'sewa' && info != 'karyawan'){
        res.json({ket : 'Invalid Url'})
    }else{
...
// end-point POST
app.post('/:info',validateToken(),(req,res)=>{
    var info = req.params.info
    if(info != 'mobil' && info != 'pelanggan' && info != 'sewa' && info != 'karyawan'){
        res.json({ket : 'Invalid Url'})
...
// end-point PUT
app.put('/:info',validateToken(),(req,res)=>{
var info = req.params.info    
    if(info != 'mobil' && info != 'pelanggan' && info != 'sewa' && info != 'karyawan'){
        res.json({ket : 'Invalid Url'})
    ...
    // end-point DELETE
    app.delete('/:info/:id',validateToken(),(req,res)=>{
        var info = req.params.info    
        if(info != 'mobil' && info != 'pelanggan' && info != 'sewa' && info != 'karyawan'){
            res.json({ket : 'Invalid Url'})
        }else{        
